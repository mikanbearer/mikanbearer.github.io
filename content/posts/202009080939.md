---
title: "使用Matplotlib做簡單的資料可視化"
date: 2020-09-08T09:39:01+08:00
draft: true
categories: [資料分析]
tags: [Python, Matplotlib]
---
遲來的資料分析，一次做太多自己沒辦法進入狀況，先從練習資料可視化開始熟悉手邊工具，之後再循序漸進繼續練習
<!--more-->
練習的檔案，是用之前抓的PTT貼文
...
### 使用Jupyter Notebook操作並以inline方式顯示圖片
---
<br></br>
...
![](5.png)
<br></br>
接下來就能進入notebook操作了，還能將檔案存成.ipynb，方便觀看
![](6.png)
<br></br>
加上下列就能將圖片inline顯示
```
